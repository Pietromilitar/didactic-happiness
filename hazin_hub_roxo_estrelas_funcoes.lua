...
local function createStars(parent)
	...
	for i = 1, 32 do
		...
		star.Text = ({ "✦", "✧", "•", "⋆" })[math.random(1, 4)]
		star.TextColor3 = Color3.fromRGB(255, 255, 255)
		star.TextTransparency = math.random(15, 55) / 100
		star.TextSize = math.random(10, 24)
		star.Font = Enum.Font.GothamBold
		star.Size = UDim2.new(0, 24, 0, 24)
		star.Position = UDim2.new(math.random(), 0, math.random(-100, 100) / 100, 0)
		star.ZIndex = 0
		star.Parent = parent
		...
		task.spawn(function()
			while star.Parent do
				...
				local endPos = UDim2.new(star.Position.X.Scale + math.random(-8, 8) / 100, 0, 1.15, 0)
				local t = math.random(45, 95) / 10

				tween(star, t, {
					Position = endPos,
					Rotation = star.Rotation + math.random(90, 360),
				}, Enum.EasingStyle.Linear)

				task.wait(t + math.random(0, 20) / 10)
			end
		end)
	end
end
...
gradient(main, Color3.fromRGB(164, 6, 163), Color3.fromRGB(70, 7, 162), 45)
...
gradient(searchFrame, Color3.fromRGB(50, 5, 117), Color3.fromRGB(185, 8, 227), -90)
...
gradient(tabs, Color3.fromRGB(133, 12, 166), Color3.fromRGB(185, 8, 227), 45)
...
gradient(content, Color3.fromRGB(50, 5, 117), Color3.fromRGB(105, 15, 150), 45)
...
local function basicButtonStyle(b)
	...
	gradient(b, Color3.fromRGB(50, 5, 117), Color3.fromRGB(185, 8, 227), 45)
	pressEffect(b)
end
